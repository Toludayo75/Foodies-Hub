...
import { Bell, Check, CheckCheck, Truck, MapPin, ArrowLeft } from "lucide-react";
      ...
      {notifications.length === 0 ? (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-600 mb-2">No Delivery Assignments</h3>
            <p className="text-gray-500">You're all caught up! New delivery assignments will appear here.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-4">
          {notifications.map((notification: any) => (
            <Card
              ...
              className={`transition-all duration-200 hover:shadow-md ${
                !notification.isRead ? 'border-l-4 border-l-orange-500 bg-orange-50/50' : ''
              }`}
            >
              <CardContent className="p-4">
